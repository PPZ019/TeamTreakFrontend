...
const Navigation = () => {
  ...
  return (
    <nav className="bg-white px-4 py-4 flex justify-between items-center text-black z-50 relative">
      ...
      <div className="flex items-center gap-4">
        ...
        {/* Select Dropdowns */}
        <select className="border-2 border-[#4D55CC] rounded-lg p-2 text-sm text-[#4D55CC]">
          <option>Main</option>
          <option>Add..</option>
        </select>
        <select className="border-2 border-[#4D55CC] rounded-lg p-2 text-sm text-[#4D55CC]">
