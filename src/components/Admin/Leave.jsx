...
const Leave = () => {
  ...
  const approveApplication = async () => {
    ...
    const updatedApplication = { ...application, adminResponse: "Approved" };
    const res = await updateLeave(id, updatedApplication);
    if (res.success) {
  ...
  const rejectApplication = async () => {
    ...
    const updatedApplication = { ...application, adminResponse: "Rejected" };
    const res = await updateLeave(id, updatedApplication);
    if (res.success) {
          ...
          <section className="section">
            ...
            <div className="col-md-9">
              ...
              <button
                ...
                className={`btn btn-lg m-4 btn-icon-split ${application.adminResponse === "Approved" ? "btn-secondary" : "btn-success"}`}
              >
                Approve
              </button>
              <button
                ...
                className={`btn btn-lg m-4 btn-icon-split ${application.adminResponse === "Rejected" ? "btn-secondary" : "btn-danger"}`}
              >
                Reject
              </button>
            </div>
