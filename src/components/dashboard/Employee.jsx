...
=======
  ...
  // ✅ Helper: Cloudinary delivers a full HTTPS URL, so just return it.
//   const getImageUrl = (imgPath) => {
//   if (!imgPath) return 'https://picsum.photos/150';
//   if (imgPath.startsWith('http')) return imgPath;

//   return `https://res.cloudinary.com/dfl011xpe/image/upload/${imgPath}`;
// };
const getImageUrl = (imgPath) => {
  return imgPath || "https://picsum.photos/150";
};
      ...
      <section className="max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg mb-6 transform transition-all hover:scale-105 duration-300 relative overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-900 to-blue-800 text-white rounded-t-lg p-6 relative">
            ...
            <p className="text-sm mt-2 text-blue-100 animate-slideUp">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
              ...
              <div className="flex justify-center items-center">
                <img
                  ...
                  onError={(e) => {
                    console.log(
                      '❌ Image failed to load, fallback triggered'
                    );
